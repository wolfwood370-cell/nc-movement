...
export const SFMA_PATTERNS = [
  ...
  { key: 'upper_extremity_pattern_2_l', label: 'UE Pattern 2 (LRF) — Sinistro', breakout: 'UE Pattern 2 Breakout (Sx)' },
  { key: 'upper_extremity_pattern_2_r', label: 'UE Pattern 2 (LRF) — Destro', breakout: 'UE Pattern 2 Breakout (Dx)' },
