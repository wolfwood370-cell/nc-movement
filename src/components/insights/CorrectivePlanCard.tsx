        ...
        <CardContent>
          <Tabs defaultValue="threer" className="w-full">
            <TabsList className="grid grid-cols-2 w-full h-auto gap-1">
              <TabsTrigger
                value="threer"
                className="flex flex-col items-center gap-0.5 whitespace-nowrap leading-tight px-2 py-2 h-auto"
              >
                <span className="text-xs sm:text-sm font-semibold">Daily 3R</span>
                <span className="text-[10px] opacity-70">Routine Quotidiana</span>
              </TabsTrigger>
              <TabsTrigger
                value="ramp"
                className="flex flex-col items-center gap-0.5 whitespace-nowrap leading-tight px-2 py-2 h-auto"
              >
                <span className="text-xs sm:text-sm font-semibold">RAMP-6</span>
                <span className="text-[10px] opacity-70">Pre-Workout</span>
              </TabsTrigger>
            </TabsList>
